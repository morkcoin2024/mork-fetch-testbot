...
class JupiterEngine:
    ...
    def preflight_checks(
        self, wallet_address: str, token_mint: str, amount_sol: float
    ) -> tuple[bool, str]:
    ...
    def safe_swap(
        self, private_key_b58: str, token_mint: str, amount_sol: float, slippage_bps: int = 300
    ) -> dict:
        ...
        try:
            ...
            quote_response = requests.get(
                f"{self.quote_api}/quote", params=quote_params, timeout=15
            )
            ...
            if swap_response.status_code != 200:
                return {
                    "success": False,
                    "error": f"Swap build failed: {swap_response.status_code}",
                }
