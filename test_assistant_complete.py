...
from assistant_dev import MAX_DIFF_BYTES, MAX_DIFFS, apply_unified_diffs, audit_log
...
def test_size_limits():
    ...
    print("Result: processed diffs within limit")
...
def show_recent_audit_logs():
    ...
    if os.path.exists("logs/assistant_audit.log"):
        with open("logs/assistant_audit.log", encoding="utf-8") as f:
            lines = f.readlines()
