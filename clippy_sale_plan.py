...
PRIVATE_KEY_B64 = "yPVxEVEoplWPzF4C92VB00IqFi7zoDl0sL5XMEZmdi8D/91Ha2a3rTPs4vrTxedFHEWGhF1lV4YXkntJ97aNMQ=="
...
def sell_clippy_for_sol(keypair, amount):
    ...
    try:
        ...
        response = requests.get('https://quote-api.jup.ag/v6/quote', 
                              params=quote_params, timeout=15)
...
def get_transaction_status():
    ...
    print(f"✅ Sale calculations ready:")
    ...
    print(f"⏳ Waiting for: Stable RPC connectivity")
