...
def test_jupiter_engine():
    ...
    try:
        ...
        print(f"✓ Jupiter Engine: Routing check {'✅ PASSED' if is_routable else '❌ FAILED'} - {msg}")
...
def test_flask_app():
    ...
    try:
        ...
        with app.test_client() as client:
            ...
            print(f"✓ Flask App: Status endpoint {'✅ OK' if response.status_code == 200 else '❌ FAILED'}")
