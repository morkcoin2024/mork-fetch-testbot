...
def test_assistant_integration():
    ...
    try:
        from assistant_dev_lite import assistant_codegen, apply_unified_diffs, maybe_run_commands
        from config import ASSISTANT_MODEL, ASSISTANT_WRITE_GUARD, ASSISTANT_FAILSAFE
    ...
    try:
        from assistant_dev_lite import ApplyResult
