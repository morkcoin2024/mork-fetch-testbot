...
def test_complete_integration():
    ...
    print("   ✅ Available Commands: /rules_show, /rules_profile, /rules_set, /rules_reload")
    print()
    ...
    print(
        f"   • Age Range: {conservative_summary['key_filters']['min_age_minutes']}-{conservative_summary['key_filters']['max_age_minutes']} min"
    )
    ...
    print(
        f"   • Age Range: {degen_summary['key_filters']['min_age_minutes']}-{degen_summary['key_filters']['max_age_minutes']} min"
    )
    print()
