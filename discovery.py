...
class TokenDiscovery:
    ...
    def validate_token_for_trading(self, mint: str, test_amount: float = 0.001) -> Tuple[bool, str, Dict]:
        ...
        try:
            ...
            validation_data = {
                "mint": mint,
                "routable": True,
                "expected_tokens_per_sol": expected_tokens / test_amount if expected_tokens > 0 else 0,
    ...
    def find_tradeable_token(self) -> Optional[Dict]:
