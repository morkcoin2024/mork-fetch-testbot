...
def preview_buy(mint: str, symbol: str, sol_amount: float, slippage_bps: int) -> Tuple[float, float]:
    """
...
def execute_buy(mint: str, symbol: str, sol_amount: float, slippage_bps: int) -> Tuple[float, float]:
    """
...
def preview_sell(mint: str, symbol: str, qty_tokens: float, slippage_bps: int) -> Tuple[float, float]:
...
def execute_sell(mint: str, symbol: str, qty_tokens: float, slippage_bps: int) -> Tuple[float, float]:
