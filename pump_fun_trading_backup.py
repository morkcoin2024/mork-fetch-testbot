...
Fixed based on user feedback - NO manual SystemProgram.transfer, ONLY PumpPortal API for token minting
Features:
- 3-attempt retry logic with exponential backoff
- 30-second timeout protection  
- Proper transaction signing and blockchain submission
- Demo mode for unfunded wallets, real trading for funded wallets
"""
import requests
import json
import logging
