...
from risk import check_safe_mode, comprehensive_safety_check
from wallet import create_wallet, get_private_key, get_wallet, import_wallet
...
def test_token_discovery():
    ...
    if token:
        ...
        return jsonify({"success": False, "error": "No working tokens found"})
