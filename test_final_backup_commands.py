...
from alerts.telegram import (
    cmd_assistant_backup_standalone, cmd_assistant_list_backups,
...
def test_complete_backup_system():
    ...
    print(")")
    print()
    print("dispatcher.add_handler(CommandHandler('assistant_backup', cmd_assistant_backup_standalone))")
    print("dispatcher.add_handler(CommandHandler('assistant_list_backups', cmd_assistant_list_backups))")
